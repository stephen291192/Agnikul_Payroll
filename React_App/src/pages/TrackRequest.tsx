...
import { MdOutlineVisibility, MdOutlineModeEdit } from "react-icons/md";
  ...
  const columns = [
    {
      key: "S_no",
      label: "S.No",
      _style: { width: "10%", textAlign: "center", backgroundColor: "#A5D0A9" },
      filter: false,
      sorter: false,
    },
    {
      key: "RequestId",
      label: "Request Id",
      _style: { width: "28%", textAlign: "center", backgroundColor: "#A5D0A9" },
      filter: true,
      sorter: true,
    },
    {
      key: "RequestType",
      label: "Request Type",
      _style: { width: "25%", textAlign: "center", backgroundColor: "#A5D0A9" },
      filter: true,
      sorter: true,
    },
    {
    ...
    },
    {
      key: "action",
      label: "Action",
      _style: { width: "15%", textAlign: "center", backgroundColor: "#A5D0A9" },
      filter: false,
      sorter: false,
    },
  ];
          ...
          <Box>
            <div className="m-4">
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                >
                  {drawerDetails.RequestType} Request
                  {/* {JSON.stringify(drawerHeading)} */}
                </Box>
                <Button
                  className="closeX"
                  sx={{
